    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-warning">
                <strong>Selamat Datang di Sistem Informasi Pengolahan Data Produksi & Distribusi Kelapa Sawit</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Field</th><th>Nama Pemanen</th><th>Hasil Panen</th><th>Tanggal Panen</th><th>Keterangan</th>
                            </tr>
                            </tr>
                        </thead>
                        <tbody>
