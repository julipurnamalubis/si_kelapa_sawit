...
<html>
    <head>
        <title>Cetak Data Hasil PanenPerbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA HASIL PANEN BULAN   <?php echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tbl_hasilpanen WHERE substr(tgl_panen,1,7)='$ambilthn-$ambilbln'";
