...
<html>
    <head>
        <title>Cetak Data Pengiriman Produksi Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PENGIRIMAN PRODUKSI BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM pengiriman_produksi WHERE substr(tgl_pengiriman,1,7)='$ambilthn-$ambilbln'";
