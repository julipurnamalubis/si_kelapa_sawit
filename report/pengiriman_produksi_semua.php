...
<html>
    <head>
        <title>Cetak Data Semua Pengiriman Produksi</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA SELURUH Pengiriman Produksi</h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                                <thead>
								<tr>
									<th>No.</th><th width="18%">Nomor Field</th><th>Total Pengiriman</th><th>Tanggal Pengiriman</th><th>Tanggal Kembali</th><th>Lama Pengiriman</th>
								</tr>
								</thead>
							<tbody>
