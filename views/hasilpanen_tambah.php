                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="ruang_arsip" class="col-sm-3 control-label">Laporan</label>
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="no_field" class="form-control" id="inputEmail3" placeholder="Inputkan Nomor field" required>
                            </div>
                        </div>
						 <div class="form-group">
                            <label for="nama_pemanen" class="col-sm-3 control-label">Nama Pemanen</label>
                            <div class="col-sm-9">
                                <input type="text" name="nama_pemanen" class="form-control" id="inputEmail3" placeholder="Inputkan Nama Pemanen" required>
                            </div>
                        </div>
						 <div class="form-group">
                            <label for="hasil_panen" class="col-sm-3 control-label">Hasil Panen</label>
                            <div class="col-sm-9">
                                <input type="text" name="hasil_panen" class="form-control" id="inputEmail3" placeholder="Inputkan Hasil Panen" required>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="date" name="tgl_panen" class="form-control" id="inputEmail3" placeholder="Inputkan Tanggal Panen" required>
                            </div>
...
if($_POST){
  ...
  $tglpanen=$_POST['tgl_panen'];
    ...
    //buat sql
    $sql="INSERT INTO tbl_hasilpanen VALUES ('','$laporan','$nomorfield','$namapemanen','$hasilpanen','$tglpanen','$keterangan')";
